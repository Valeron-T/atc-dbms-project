<?php
    ...
    function Message($msg, $err_or_suc)
    {
        if ($err_or_suc == "err") {
        ...
        if(strpos($gate_result['aircraft_type'], $ac_type) !== false){
            ...
            if ($origin !== $destination) {
                ...
                elseif ($deparr === 'ARR') {
                    ...
                    $error_msg = "Something went wrong. Try rechecking A/C type.";
                    Message($error_msg, "err");
                }
            } else {
...
<head>
    ...
    <script type="text/javascript" src="create-flight.js"></script>
	<!--This above script tag is used to load the offline jQuery -->

	<link rel="stylesheet" type="text/css" href="create-flight.css">
