...
<head>
	...
	<link rel="stylesheet" type="text/css" href="departure--CSS.css">

	<title>Departure - Table</title>
</head>
<body class="bg-color-golden-silk">
	...
	<div class="container-fluid">
		...
		<div class="container pt-5">
			...
			<div class="container">
				<h3 class="p-3 text-center fs-1 style1">Departures</h3>
			</div>
			...
			<div class="container justify-content-center">
				...
				<div class="pt-1 pb-1">
					...
					<?php
						$flights = "Select * from departures order by time asc";
