...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ground--CSS.css">

	<title>Ground - Table</title>
</head>
<body class="bg-color-day-sky-blue">
	...
	<div class="container-fluid">
		...
		<div class="container pt-5">
			...
			<div class="container">
				<h3 class="p-3 text-center fs-1 style1">Parked Aircrafts</h3>
			</div>
			...
			<div class="container justify-content-center">
				...
				<div class="container fw-bold text-uppercase mb-2" id="table-heading">
					<div class="row">
						...
						<div class="col p-1 ms-1 style5">
							<p class="mb-0 text-center">Dep/Arr</p>
						</div>
						<div class="col p-1 ms-1 style6">
				...
				<div class="pt-1 pb-1">
					...
					<?php
						$flights = "Select * from flights where status in ('Expected', 'Scheduled') order by time asc;";
						...
						if ($result->num_rows > 0) {
							...
							while($row = $result->fetch_assoc()) {
								...
								<div class='col p-1 ms-1 style4'>
									<p class='mb-0 text-center'>".$row['deparr']."</p>
								</div>
								<div class='col p-1 ms-1 style4'>
